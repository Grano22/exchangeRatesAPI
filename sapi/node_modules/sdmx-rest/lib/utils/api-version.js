...
(function() {
  ...
  var resources, resourcesV1, resourcesV3, resourcesV5, versions;
  ...
  resourcesV1 = ['datastructure', 'metadatastructure', 'categoryscheme', 'conceptscheme', 'codelist', 'hierarchicalcodelist', 'organisationscheme', 'agencyscheme', 'dataproviderscheme', 'dataconsumerscheme', 'organisationunitscheme', 'dataflow', 'metadataflow', 'reportingtaxonomy', 'provisionagreement', 'structureset', 'process', 'categorisation', 'contentconstraint', 'attachmentconstraint', 'structure', 'data', 'metadata'].sort();

  resourcesV3 = (['actualconstraint', 'allowedconstraint', 'availableconstraint'].concat(resourcesV1)).sort();

  resourcesV5 = (['transformationscheme', 'rulesetscheme', 'userdefinedoperatorscheme', 'customtypescheme', 'namepersonalisationscheme', 'namealiasscheme'].concat(resourcesV3)).sort();
